            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-2">
              {alternatives.length === 0 ? (
                <div className="text-center py-8 text-text-muted">
                  ...
                  <p className="text-sm">No nearby alternatives found</p>
                  <p className="text-xs mt-1 opacity-60">Try rerolling or building a new route</p>
                </div>
              ) : (
                alternatives.map(alt => {
                  ...
                  return (
                    ...
                    >
                      {/* Emoji */}
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-rally-500/15 to-rally-pink/15 flex items-center justify-center text-lg shrink-0">
